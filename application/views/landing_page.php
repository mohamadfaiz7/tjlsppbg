                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_2">TJLSP</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_3">Laporan</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link click-scroll" href="#section_4">Kegiatan</a>
                            </li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <h2 class="text-white">TJLSP</h2>

                            <h1 class="cd-headline rotate-1 text-white mb-4 pb-2">
                                <span>Merupakan Tanggung jawab Tentang</span>
                                <span class="cd-words-wrapper">
                                    <b class="is-visible">Sosial</b>
                                    <b>Lingkungan</b>
                                    <b>Ekonomi</b>
                                </span>
                            </h1>
                            ...
                            <div class="custom-btn-group">
                                <a href="#section_2" class="btn custom-btn smoothscroll me-3">TJLSP</a>

                                <a href="#section_3" class="link smoothscroll">Laporan</a>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h2 class="mb-lg-5 mb-4">About TJLSP Purbalingga</h2>
                        </div>

                        <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                            <h3 class="mb-3">TJLSP Purbalingga</h3>

                            <p><strong>TJLSP</strong>, Purbalingga mengusung beberapa program yang membantu dan melaksanakan tugas untuk Sosial,Lingkungan dan Ekonomi</p>

                            <p>Hasil Kerja sama antara Dinas Komunikasi dan informasi Purbalingga dan Dinas Sosial Purbalingga.</p>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="section-bg-image-block">
                                <h2 class="mb-lg-3">Komentar</h2>

                                <p>Untuk memberikan tingkat kepuasan pelayanan dan peningkatan kualitas Masukan Komentar anda.</p>

                                <form action="#" method="get" class="custom-form mt-lg-4 mt-2" role="form">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-text bi-envelope" id="basic-addon1"></span>

                                        <input type="email" name="email" id="email" pattern="[^ @]*@[^ @]*" class="form-control" placeholder="Komentar" required="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center mx-auto mb-lg-5 mb-4">
                            <h2><span>Laporan</span>TJLSP</h2>
                        </div>

                        <div class="col-lg-6 col-12 mb-3 mb-lg-0">
                            <h4 class="mb-4 pb-lg-2">Kriteria</h4>

                            <div class="table-responsive">
                                <table class="table text-center">
                                    <thead>
                                        <tr>
                                            <th style="width: 34%;">Layanan Tindakan</th>
                                            
                                            <th style="width: 22%;">Sosial</th>
                                            
                                            <th style="width: 22%;">Lingkungan</th>
                                            
                                            <th style="width: 22%;">Ekonomi</th>
                                        </tr>
                                    </thead>

                                    <tbody>
                                        <tr>
                                            <th scope="row" class="text-start">kemiskinan</th>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">ketelantaran</th>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Keterpencilan</th>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Tuna sosial</th>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Penyimpangan Perilaku</th>
                                        ...
                                        <tr>
                                            <th scope="row" class="text-start">Korban bencana,kekerasan,eksploitasi dan diskriminasi</th>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <h2 class="mb-lg-3">Event TJLSP</h2>
                        </div>
                        ...
                        <div class="row custom-block mb-3">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    <a href="event-detail.html" class="events-title mb-3">Event Dinkominfo</a>
                                    ...
                                    <div class="d-flex flex-wrap border-top mt-4 pt-3">
                                        ...
                                        <div class="d-flex align-items-center ms-lg-auto">
                                            <a href="event-detail.html" class="btn custom-btn">View More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row custom-block custom-block-bg">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    <a href="event-detail.html" class="events-title mb-3">Event lainnya</a>
                                    ...
                                    <div class="d-flex flex-wrap border-top mt-4 pt-3">
                                        ...
                                        <div class="d-flex align-items-center ms-lg-auto">
                                            <a href="event-detail.html" class="btn custom-btn">Veiw More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12">
                            <form action="#" method="post" class="custom-form contact-form" role="form">
                                <h2 class="mb-4 pb-2">Kontak Kami</h2>
            ...
            <div class="container">
                <div class="row">
                        ...
                        <div class="col-lg-2 col-12 ms-auto">
                            ...
                            <p> &copy; Dinas Komunikasi dan Informatika Purbalingga </p>
                            <p class="copyright-text">Design: <a rel="nofollow" href="" target="_blank">V01.2023 </a></p>
                            <a href="https://swu.ac.id">Stmik Widya Utama</a>
                        </div>
